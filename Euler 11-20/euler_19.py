...
but not on a century unless it's divisible by 400. 
Calculate how many Sundays fell on the first of the month between two years in 
the 20th century. """

def sundays_count(start_year, end_year):
    """ adaptation of Zeller's Congruence to find the day on which January 1st 
    fell in the given start year. This considers leap years and the number of 
    years since 1 AD. """
